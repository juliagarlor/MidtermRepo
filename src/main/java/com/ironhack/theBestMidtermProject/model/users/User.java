...
//User is the parent class of AccountHolder, Admin and ThirdParty. An user has an autogenerated and distinctive id,
// a name, an age, a password, a set of roles and a BCrypt password encoder object in order to encode the password.
...
//    Name is an embedded object whose class can be found inside Utils -> classes
    @Embedded
...
//    Constructor with all parameters
    public User(Name name, String password, int age, Set<Role> roles) {
        this.name = name;
//        We encode the password as soon as the object is constructed
